...
const T = {
  pt: {
    ...
    founders: [
      ...
      { name:"José Carlos de Paula", role:"CSO · Co-Founder",
  ...
  en: {
    ...
    closeCvHref: "mailto:contato@wirinnovation.ai?subject=Career%20interest%20%C2%B7%20WIR%20Innovation&body=Hello%2C%20I%27d%20like%20to%20learn%20about%20opportunities%20at%20WIR%20Innovation.",
          ...
          <div className="abessay__content">
            {paragraphs.map((p,i) => (
              <div key={i} className="abessay__para">
                <div className="abessay__para-k">· {p.k}</div>
