...
const T = {
  ...
  en: {
    ...
    stages: [
      { k:"01", t:"Application Intake",      d:"Multichannel intake and automatic validation · API · Portal · Upload · real-time validation.", c:"#3B82F6" },
      { k:"02", t:"AI Document Extraction",  d:"Intelligent document reading · automatic field extraction with high precision.",               c:"#7540AC" },
      { k:"03", t:"Business Intelligence",   d:"Broker enrichment and context · score · conversion history · prioritization.",                 c:"#A44F98" },
      { k:"04", t:"Risk Assessment",         d:"Risk & fraud engine · risk score · probability · automated decision.",                          c:"#EE7D48", tag:"SS" },
  ...
  es: {
    ...
    stages: [
      { k:"01", t:"Application Intake",      d:"Entrada multicanal y validación automática · API · Portal · Upload · validación en tiempo real.", c:"#3B82F6" },
      ...
      { k:"03", t:"Business Intelligence",   d:"Enriquecimiento y contexto del corredor · score · historial de conversión · priorización.",       c:"#A44F98" },
      { k:"04", t:"Risk Assessment",         d:"Motor de riesgo y fraude · score de riesgo · probabilidad · decisión automatizada.",              c:"#EE7D48", tag:"SS" },
